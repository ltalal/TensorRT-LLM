...
class MetricsCollector:
    ...
    def __init__(self, labels: Dict[str, str]) -> None:
        ...
        self.kv_cache_hit_rate = Gauge(
            name=self.metric_prefix + "kv_cache_hit_rate",
            documentation="KV cache hit rate",
            labelnames=self.labels.keys())
        self.kv_cache_utilization = Gauge(
            name=self.metric_prefix + "kv_cache_utilization",
    ...
    def log_request_metrics_dict(self, metrics_dict: Optional[dict[str, float]]) -> None:
        """
